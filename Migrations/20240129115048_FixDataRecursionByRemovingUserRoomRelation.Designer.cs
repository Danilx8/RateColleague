...
namespace RateColleague.Migrations
{
    ...
    [Migration("20240129115048_FixDataRecursionByRemovingUserRoomRelation")]
    partial class FixDataRecursionByRemovingUserRoomRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RateColleague.Models.Grade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RateColleague.Models.Room", b =>
                {
                    ...
                    b.Property<DateTime>("ClosePollTime")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("PublicPassword")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RateColleague.Models.Employee", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RateColleague.Models.Grade", b =>
                {
                    b.HasOne("RateColleague.Models.Question", "Question")
                        .WithMany("Grades")
